function WhatsAppIcon() {
  return (
    <svg viewBox="0 0 32 32" className="h-4 w-4 fill-[#102b22]" aria-hidden="true">
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full bg-[#102b22] text-white shadow-md">
      <div className="mx-auto flex h-20 max-w-[1500px] items-center justify-between px-4 md:px-10 lg:px-14">
        <a href="/" className="text-sm font-black uppercase tracking-[0.22em] md:text-base">
          13.892 Palavras
        </a>

        <nav className="hidden items-center gap-10 text-sm font-semibold md:flex">
          <a href="#sobre" className="transition hover:text-[#d7c7ac]">Sobre o livro</a>
          <a href="#trecho" className="transition hover:text-[#d7c7ac]">Trecho</a>
          <a href="#autor" className="transition hover:text-[#d7c7ac]">O autor</a>
          <a href="#galeria" className="transition hover:text-[#d7c7ac]">Galeria</a>
          <a href="#contato" className="transition hover:text-[#d7c7ac]">Contato</a>
        </nav>
