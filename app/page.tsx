...
const opcoes = [
  {
    ...
    descricao:
      "Livro físico enviado para seu endereço, com frete incluído.",
...
Faça o Pix do valor total e envie o comprovante para este WhatsApp.`,
...

  {
    ...
    descricao:
      "Livro físico disponível exclusivamente para retirada no dia do lançamento no Café Duca.",
    detalhe: "Retirada no lançamento • Café Duca",
    disponivel: true,
    mensagem: `Olá! Quero comprar o livro 13.892 Palavras.

OPÇÃO ESCOLHIDA
Livro físico com retirada no lançamento
Local de retirada: Café Duca
...
A retirada será realizada exclusivamente no dia do lançamento no Café Duca.
...
const whatsappCompraLiberada = criarLinkWhatsApp(opcoes[1].mensagem);
...
function SectionTitle({
  ...
  return (
    <div className={center ? "text-center" : ""}>
      ...
      <div
        className={`mt-4 h-1 w-20 rounded-full bg-[#3f9254] ${
          center ? "mx-auto" : ""
        }`}
      />
    </div>
...
function SmartImage({
  ...
  if (erro) {
    return (
      <div
        className={`${className} flex items-center justify-center bg-[#f4eadc] p-6 text-center text-sm font-bold text-[#102b22]/70`}
      >
...
export default function Home() {
  return (
    <main
      id="topo"
      className="min-h-screen overflow-x-hidden bg-[#fbf6ee] text-[#102b22]"
    >
      <Header />
      ...
      <section className="pt-[72px]">
        ...
        <div className="relative hidden overflow-hidden bg-[#f7efe4] md:block">
          ...
          <a
            href={whatsappCompraLiberada}
            target="_blank"
            rel="noopener noreferrer"
            className="absolute bottom-[4%] left-[25%] z-10 flex -translate-x-1/2 items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#46b95d] to-[#2f8b46] px-9 py-4 text-sm font-black uppercase tracking-wide text-white shadow-[0_16px_40px_rgba(63,146,84,.30)] transition hover:scale-105"
          >
            <WhatsAppIcon />
        ...
        <div className="relative overflow-hidden bg-gradient-to-b from-[#f8f0e5] to-[#fbf6ee] px-5 pb-12 pt-9 md:hidden">
          <div className="mx-auto flex max-w-[380px] flex-col items-center text-center">
            ...
            <p className="mt-7 max-w-[340px] text-[15px] leading-7 text-[#26362f]">
              Um olhar humano, sensível e verdadeiro sobre a vida além do
              diagnóstico.
            </p>

            <a
              href="#comprar"
              className="mt-7 flex w-full items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#46b95d] to-[#2f8b46] px-6 py-4 text-sm font-black uppercase tracking-wide text-white shadow-[0_14px_35px_rgba(63,146,84,.28)] transition hover:scale-[1.02]"
            >
              <WhatsAppIcon />
      ...
      >
        <div className="mx-auto grid max-w-[1250px] gap-12 lg:grid-cols-[.9fr_1.1fr]">
          <div>
            <SectionTitle
              eyebrow="Conheça a obra"
              title="Sobre o livro"
            />

            <p className="mt-7 text-[15px] leading-8 text-[#26362f]">
              Um texto surpreendente e humano sobre a rotina de quem vive
              nessa condição. Longe de ser um manual médico, a obra reúne
              histórias curiosas, leves e inesperadas do cotidiano.
            </p>

            <p className="mt-4 text-[15px] leading-8 text-[#26362f]">
              É um convite para enxergar a vida além do diagnóstico,
              celebrando a sensibilidade, o humor e a autenticidade.
            </p>
          ...
          >
            <SectionTitle
              eyebrow="Bastidores da obra"
              title="Da escrita à publicação"
            />
      ...
      <section
        id="trechos"
        className="scroll-mt-24 bg-[#eaf0e7] px-5 py-16 md:px-10 md:py-20"
      >
        <div className="mx-auto max-w-[1200px]">
          <SectionTitle
            eyebrow="Palavras do autor"
            title="Trechos da obra"
            center
          />
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                <span className="absolute left-6 top-4 font-serif text-5xl text-[#3f9254]/25">
                  “
                </span>

                <p className="font-serif text-lg italic leading-8 text-[#26362f]">
                  {trecho}
                </p>
              </article>
            ))}
        ...
        <div className="mx-auto grid max-w-[1100px] items-center gap-10 rounded-[32px] border border-[#102b22]/10 bg-white p-7 shadow-[0_24px_60px_rgba(16,43,34,.1)] md:grid-cols-[240px_1fr] md:p-10">
          ...
          <div className="text-center md:text-left">
            <SectionTitle
              ...
              title="Carlos Henrique Bitar Barbosa"
            />

            <p className="mt-6 text-[15px] leading-8 text-[#26362f]">
              Carlos Henrique Bitar Barbosa recebeu o diagnóstico de
              Parkinson aos 44 anos, 4 meses e 22 dias de idade,
              confirmando o que os sintomas já anunciavam havia algum
              tempo.
            </p>

            <p className="mt-4 text-[15px] leading-8 text-[#26362f]">
              Em vez de aceitar o diagnóstico como ponto final,
              transformou os anos de convivência diária em um laboratório
              de superações, redescobertas e criatividade.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        id="comprar"
        className="scroll-mt-20 bg-[#0d2d23] px-5 py-16 text-white md:px-10 md:py-24"
      >
        <div className="mx-auto max-w-[1180px]">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-white/70">
              A venda do livro físico para retirada no lançamento já está
              liberada.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-7 md:grid-cols-3">
            {opcoes.map((opcao, index) => {
              const disponivel = opcao.disponivel;

              return (
                <article
                  key={opcao.titulo}
                  className={`flex overflow-hidden rounded-[28px] border shadow-[0_24px_55px_rgba(0,0,0,.22)] transition ${
                    disponivel
                      ? "border-[#87e39a]/60 bg-white/15 hover:-translate-y-2"
                ...
                >
                  <div className="flex w-full flex-col">
                    ...
                    <div className="p-2 pb-0">
                      <div
                        className={`flex min-h-[112px] items-center justify-center rounded-[22px] px-4 py-4 text-center ${
                          disponivel
                            ? "border-2 border-[#87e39a] bg-white"
                            : "bg-white"
                        }`}
                      >
                        {disponivel ? (
                          <div>
                            <p className="text-xl font-black uppercase text-[#102b22]">
                              VENDA LIBERADA.
                            </p>

                            <p className="mt-3 text-sm font-black uppercase leading-5 text-[#102b22] sm:text-base">
                              EXCLUSIVAMENTE PARA RETIRADA
                              <br />
                              NO DIA DO LANÇAMENTO NO
                              <br />
                              CAFÉ DUCA
                            </p>
                          </div>
                        ) : (
                          <p className="text-base font-bold leading-6 text-[#102b22]">
                            AGUARDEM, esta opção ainda
                            <br />
                            não está liberada para venda
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      ...
                      <p className="mt-2 text-sm font-bold">
                        Quantidade: informe pelo WhatsApp
                      </p>
                      ...
                      {disponivel ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-6 flex items-center justify-center gap-3 rounded-full bg-[#3f9254] px-5 py-4 text-sm font-black uppercase text-white shadow-lg transition hover:scale-[1.03] hover:bg-[#347a46]"
                        >
                          <WhatsAppIcon />
                          Comprar pelo WhatsApp
                        </a>
                        ...
                        <button
                          type="button"
                          disabled
                          className="mt-6 flex cursor-not-allowed items-center justify-center gap-3 rounded-full bg-white/10 px-5 py-4 text-sm font-black uppercase text-white/45"
                        >
                          <WhatsAppIcon />
        ...
        <div className="mx-auto max-w-[1000px]">
          <article className="mx-auto mt-7 max-w-[650px] rounded-[28px] border border-[#102b22]/10 bg-white p-8 text-center shadow-[0_22px_50px_rgba(16,43,34,.10)]">
            ...
            <p className="mt-6 text-[15px] leading-7 text-[#26362f]">
              Acompanhe novidades, bastidores do livro e conteúdos
              exclusivos.
            </p>
      ...
      <footer
        id="contato"
        className="scroll-mt-24 bg-[#fbf6ee] px-5 py-10 md:px-10"
      >
        ...
        <div className="mx-auto mt-8 max-w-[1100px] border-t border-[#102b22]/15 pt-5 text-center text-sm text-[#26362f]">
          © 2026 Carlos Henrique Bitar Barbosa · Todos os direitos
          reservados.
        </div>
      </footer>
